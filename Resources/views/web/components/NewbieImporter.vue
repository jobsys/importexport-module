<template>
	<a-modal v-model:visible="state.visible" :title="title" :width="700" :mask-closable="false" :footer="null" @cancel="closeImporter">
		...
		<div v-if="state.stepNum === 4" class="text-center mt-6">
			...
			<div v-if="state.errorFile" class="text-left bg-gray-100 p-4 mt-4 rounded">
				<p class="mb-0">
					<a-tag color="red"> {{ state.errorRows }}</a-tag> 条异常数据
